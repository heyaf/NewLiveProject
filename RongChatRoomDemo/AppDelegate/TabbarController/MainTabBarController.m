...
-(void)setUpAllChildViewController{
    ...
    HomeViewController *firVC = [[HomeViewController alloc] init];
    NewsViewController *secVC = [[NewsViewController alloc] init];
    VideoViewController *thrVC = [[VideoViewController alloc] init];
    ProductViewController *fourVC = [[ProductViewController alloc] init];
    MineViewController *fivVC = [[MineViewController alloc] init];
    
    [self setupChildViewController:firVC title:@"首页" imageName:@"tab_home_default" seleceImageName:@"tab_home_selected"];
    [self setupChildViewController:secVC title:@"资讯" imageName:@"tab_news_default" seleceImageName:@"tab_news_selected"];
...
- (void)setViewControllers:(NSArray *)viewControllers {
    ...
    self.TabBar.itemTitleColor         = KWhiteColor;
