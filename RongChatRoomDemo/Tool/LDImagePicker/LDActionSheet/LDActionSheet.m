...
- (void)initSubViews {
    ...
    _darkShadowView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight-64)];
...
- (void)showInView:(UIView *)view {
    ...
    [UIView animateWithDuration:ACShowAnimateDuration animations:^{
        ...
        _buttonBackgroundView.transform = CGAffineTransformMakeTranslation(0, -_buttonBackgroundView.frame.size.height-64);
